...
module.exports = {
	...
	// Project options.
	projectURL: 'http://127.0.0.1/augsburger-genuss-touren.de/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// JS Custom options.
	jsCustomSRC: './js/functions.js', // Path to JS custom scripts folder.
