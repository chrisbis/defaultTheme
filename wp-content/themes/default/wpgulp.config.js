...
module.exports = {
	...
	// Project options.
	projectURL: 'localhost/petticap', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	jsCustomDestination: './js/dest/', // Path to place the compiled JS custom scripts file.
	jsCustomFile: 'dest.js', // Compiled JS custom file name. Default set to custom i.e. custom.js.
